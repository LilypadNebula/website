  ...
  <Layout>
    ...
    <FadingContent className="text-4xl font-montAlt text-center my-4">
      <p>
        ...
        apps. Need something done? Get in touch and lets work something out!
      </p>
      <p className="mt-6">
        Below is an idea of what I can do and an estimate of the costs for it.
        I'm absolutely willing to work something out for those in marginalized
      ...
      <div className="flex flex-col m-8 text-2xl font-mont">
        ...
        <p className="border-b border-black p-8">
          <span className="text-3xl">$10</span> - Extra page cost on the
          website, things beyond 5 pages or slightly more advanced ones
        </p>
        <p className="border-b border-black p-8">
