...
const Games = () => {
  return (
    <FadingContent className="text-center text-3xl font-montAlt">
      <p>
        I do game stuff! Playing them and making them. The things I'm making are
        currently in development, but keep an eye on the stream and you might
        catch me working on them, here's some info about them:
      </p>
      <div className="flex flex-col items-center my-6 font-mont">
        <p className="border-b border-black p-8">
          ...
          multiple worlds. It's meant to be hopeful and cool, about the players
          stopping baddies from being baddies
        </p>
        <p className="border-b border-black p-8">
          ...
          regular lives. Inspired by modern fantasy media and procedural shows.
        </p>
        <p className="border-b border-black p-8">
          ...
          through minigames, spending their Coin and Rep for what they want and
          what they need
        </p>
      </div>
    </FadingContent>
